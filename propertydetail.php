                ...
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;"> 
                                    <!-- Slide 1-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="100" height="400"   src="images/recent pictures/GOOD.jpg" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 2-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="images/recent pictures/GOOD.jpg" class="ls-bg" alt="" /> </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="text-success text-left h5 my-2 text-md-right">XAF <?php echo $row['13'];?></div>
                        ...
                        <div class="property-details">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseOne" class="collapse show p-4" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <img src="images/recent pictures/GOOD.jpg" alt="Not Available"> </div>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">Contact Property Owner</h5>
                            <div class="agent-contact pt-60">
                                <div class="row">
                                    <div class="col-sm-4 col-lg-3"> <img src="images/recent pictures/GOOD.jpg" alt="" height="200" width="170"> </div>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
								...
								$query=mysqli_query($con,"SELECT * FROM `property` ORDER BY date DESC LIMIT 7");
										...
										{
								?>
                                <li> <img src="images/recent pictures/GOOD.jpg" alt="pimage">
                                    <h6 class="text-secondary hover-text-success text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h6>
                                    <span class="font-14"><i class="fas fa-map-marker-alt icon-success icon-small"></i> <?php echo $row['14'];?></span>
